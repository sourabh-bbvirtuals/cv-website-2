...
export function QuizListingCard({ card }: { card: QuizListCard }) {
  ...
  return (
    <article
      className="relative flex min-h-[240px] sm:min-h-[260px] flex-col rounded-2xl px-3 md:px-6 py-6  ring-1 ring-[rgba(8,22,39,0.06)]"
      style={{
    ...
    >
      ...
      <div className="flex w-full min-w-0 flex-col gap-3">
        <div className="flex flex-wrap items-center gap-2 text-sm leading-[150%] lg:text-base lg:leading-[150%]">
          <div
          ...
          <div className="rounded border border-[rgba(8,22,39,0.1)] px-2 sm:px-3 py-0.5 sm:py-1 font-medium text-lightgray/50 text-sm lg:text-base">
            {card.board}
          </div>
      ...
      {attempted ? (
        <div className="mt-8 sm:mt-16 flex w-full gap-2 sm:gap-3">
          <Link
            ...
            className="flex h-8 sm:h-9 flex-1 items-center justify-center gap-2 rounded-[38px] border border-[rgba(58,107,252,0.2)] bg-white text-sm font-medium text-[#3a6bfc] transition-colors hover:bg-[rgba(58,107,252,0.06)] lg:text-base"
          >
            <svg
              width="20"
              height="20"
          ...
          <Link
            ...
            className="flex h-8 sm:h-9 flex-1 items-center justify-center gap-2 rounded-[38px] border border-[rgba(8,22,39,0.1)] bg-white text-sm font-medium text-lightgray/80 transition-colors hover:bg-lightgray/5 lg:text-base"
          >
            <svg
              width="20"
              height="20"
