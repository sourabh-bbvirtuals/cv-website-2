        ...
        <div className="fixed inset-0 overflow-y-auto overflow-x-hidden">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel
                className={clsx(
                  'flex flex-col justify-start overflow-auto transform bg-white text-left align-middle shadow-xl transition-all',
                  noPadding ? '' : 'p-10',
                  fitContent ? 'w-auto h-auto max-w-none' : 'w-full h-full',
                  {
                    'max-w-md': size === 'small',
